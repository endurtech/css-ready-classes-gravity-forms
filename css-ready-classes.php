...
// Considering adding this function in a later version.
/*if( ! function_exists( 'hide_gf_tooltips' ) )
{
...
function cssready_select_classes_js()
{
  ...
  <div id='css_ready_modal'>
    ...
    Did <a href='https://endurtech.com/css-ready-classes-plugin/' target='_blank' title='Opens New Window'>our plugin</a> save you time? <a href='https://paypal.me/endurtechnology/5' target='_blank' title='Opens New Window'><strong>Share your appreciation</strong></a> and support future improvements.</p>
    <ul class='cssr_ul'>
      <li>
        <span>Columns</span>
        <div>
